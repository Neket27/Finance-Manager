...
public class UserAuth {
    ...
    public void registerUser() {
        ...
        boolean isRegistered = authService.register(new CreateUserDto(name, email, password));

        if (isRegistered)
            userOutput.print("Регистрация успешна!");
        else
            userOutput.print("Ошибка регистрации. Попробуйте снова.");
